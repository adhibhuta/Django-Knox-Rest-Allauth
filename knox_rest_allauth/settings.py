"""
Django settings for knox_rest_allauth project.
...
SECRET_KEY = '$%gf0&l!^ftu=#7_bzzv4rbttvoz6&53hnznj3fv2(!=@mtsaf'
...
ROOT_URLCONF = 'knox_rest_allauth.urls'
...
WSGI_APPLICATION = 'knox_rest_allauth.wsgi.application'
